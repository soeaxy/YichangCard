...
var XXHCLASS = ee.Image("users/wufvckshuo/xxh7ClassLanduse"),
    XXH = ee.FeatureCollection("users/wufvckshuo/XiangxihePolygon"),
    water = /* color: #d63000 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([110.74538811979647, 31.372182396476788]),
            {
              "class": 1,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([110.74452981291171, 31.378777594977972]),
            {
              "class": 1,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([110.75568780241366, 31.391087393423398]),
            {
              "class": 1,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([110.74693307218905, 31.370423598692195]),
            {
              "class": 1,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([110.76118096647616, 31.393138869632782]),
            {
              "class": 1,
              "system:index": "4"
            })]),
    city = /* color: #98ff00 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([110.7493363314664, 31.35034165775182]),
            {
              "class": 2,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([110.7525978976285, 31.35503271404634]),
            {
              "class": 2,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([110.75139626798983, 31.34638339699229]),
            {
              "class": 2,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([110.74573144255038, 31.33787990324409]),
            {
              "class": 2,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([110.74452981291171, 31.35107465072292]),
            {
              "class": 2,
              "system:index": "4"
            })]),
    guanmu = /* color: #0b4a8b */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([110.76633080778475, 31.370570166431555]),
            {
              "class": 3,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([110.76924905119296, 31.373648036151053]),
            {
              "class": 3,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([110.77233895597811, 31.375846452798207]),
            {
              "class": 3,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([110.7302819186246, 31.34638339699229]),
            {
              "class": 3,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([110.71981057463046, 31.34491733221635]),
            {
              "class": 3,
              "system:index": "4"
            }),
        ee.Feature(
            ee.Geometry.Point([110.71466073332186, 31.34286480314378]),
            {
              "class": 3,
              "system:index": "5"
            })]),
    field = /* color: #ffc82d */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([110.80598458586093, 31.344697420529208]),
            {
              "class": 4,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([110.80941781339999, 31.338539684571913]),
            {
              "class": 4,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([110.67809686003085, 31.34616348873256]),
            {
              "class": 4,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([110.6672821932828, 31.342205052145555]),
            {
              "class": 4,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([110.6617890292203, 31.34088553626905]),
            {
              "class": 4,
              "system:index": "4"
            })]),
    forest = /* color: #00ffff */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([110.68032845793124, 31.380609512400255]),
            {
              "class": 5,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([110.7907067233121, 31.39130719658974]),
            {
              "class": 5,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([110.8210907870328, 31.36492714345528]),
            {
              "class": 5,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([110.70418938932772, 31.385005968455467]),
            {
              "class": 5,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([110.65406426725741, 31.376212850571786]),
            {
              "class": 5,
              "system:index": "4"
            }),
        ee.Feature(
            ee.Geometry.Point([110.75688943205233, 31.38104916726586]),
            {
              "class": 5,
              "system:index": "5"
            })]),
    rawfield = /* color: #bf04c2 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([110.81679925260897, 31.586947111512238]),
            {
              "class": 6,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([110.82057580290194, 31.586142847957714]),
            {
              "class": 6,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([110.86340531645175, 31.60069163356866]),
            {
              "class": 6,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([110.90022668180819, 31.615018869436845]),
            {
              "class": 6,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([110.88400468168612, 31.59294231197959]),
            {
              "class": 6,
              "system:index": "4"
            })]),
    ...
    water2 = /* color: #0300ff */ee.FeatureCollection(
        [ee.Feature(
...
var newfc = water.merge(city).merge(guanmu).merge(field).merge(rawfield).merge(forest);
...
Map.addLayer(classified.clip(XXH), {min: 0, max: 2, palette: ['red', 'green', 'blue']});
...
Export.image.toDrive({
            image: classified.clip(XXH),
            description: 'XXHClass2019',
            folder:'XXH',
            region:  XXH.geometry(),
            scale: 30,
            crs: "EPSG:4326",
